...
<head>
  ...
  <!-- Daterangepicker -->
  <link rel="stylesheet" href="<?php echo(PT_LoadAdminLink('vendors/datepicker/daterangepicker.css')) ?>"
    type="text/css">
  ...
  <link href="<?php echo PT_LoadAdminLink('vendors/bootstrap-tagsinput/src/bootstrap-tagsinput.css'); ?>"
    rel="stylesheet" />
  <?php } ?>
...
$(function() {
  ...
  $(document).on('click', 'a[data-ajax]', function(e) {
    ...
    e.preventDefault();
    if (($(this)[0].hasAttribute("data-sent") && $(this).attr('data-sent') == '0') || !$(this)[0].hasAttribute(
        "data-sent")) {
      ...
      $.post("<?php echo $pt->config->site_url.'/admin_load.php';?>" + url, {
        url: url
      }, function(data) {
...
<body <?php echo ($pt->mode == 'night' || $pt->config->night_mode == 'night' ? 'class="dark"' : ''); ?>>
        ...
        <div class="header-left">
          ...
          <div class="header-logo">
            <a href="<?php echo $pt->config->site_url ?>">
              <img class="logo"
                src="<?php echo $pt->config->theme_url ?>/img/logo-light.png?cache=<?php echo($pt->config->logo_cache) ?>"
                alt="logo">
            </a>
          </div>
        </div>
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                  <div class="border-bottom px-3 py-3 text-center d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Notifications</h5>
                    <?php if ($notify_count > 0) { ?>
                    <a class="btn btn-sm btn-success" href="javascript:void(0)" onclick="ReadNotify()"><svg
                        xmlns="http://www.w3.org/2000/svg" class="mr-2" width="16" height="16" viewBox="0 0 24 24">
                  ...
                  <div class="dropdown-scroll">
                    <ul class="list-group list-group-flush">
                      <?php if ($notify_count > 0) { ?>
                      <li class="px-4 py-2 text-center small text-muted bg-light"><?php echo $notify_count; ?> Unread
                        Notifications</li>
                      ...
                      <li class="px-3 py-3 list-group-item">
                        <a href="<?php echo PT_LoadAdminLinkSettings($page_); ?>"
                          ...
                          <div class="flex-shrink-0">
                            <figure class="avatar mr-3">
                              <span class="avatar-title bg-info-bright text-info rounded-circle">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 426.667 426.667" height="20"
                                  width="20" fill="#04abf2">
                                  <g>
                                    <g>
                                      <g>
                                        <path
                                        ...
                                        <path
                                          d="M384,0H128c-23.573,0-42.667,19.093-42.667,42.667v256c0,23.573,19.093,42.667,42.667,42.667h256 c23.573,0,42.667-19.093,42.667-42.667v-256C426.667,19.093,407.573,0,384,0z M213.333,266.667v-192l128,96L213.333,266.667z">
                                        </path>
                                      </g>
                                    </g>
                                  </g>
              ...
              <li class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" title="User menu" data-toggle="dropdown">
                  <figure class="avatar avatar-sm">
                    <img src="<?php echo $pt->user->avatar; ?>" class="rounded-circle" alt="avatar">
                  </figure>
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                  <div class="text-center py-4">
                    <figure class="avatar avatar-lg mb-3 border-0">
                      <img src="<?php echo $pt->user->avatar; ?>" class="rounded-circle" alt="image">
                    </figure>
                  ...
                  <div class="list-group">
                    ...
                    <a href="javascript:void(0)" class="list-group-item admin_mode" onclick="ChangeMode('day')">
                      ...
                      <svg class="feather feather-moon" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
          ...
          <ul>
            ...
            <li>
              <a <?php echo ($page == 'dashboard') ? 'class="active"' : ''; ?>
                href="<?php echo PT_LoadAdminLinkSettings(''); ?>" data-ajax="?path=dashboard">
            ...
            <li
              <?php echo ($page == 'general-settings' || $page == 'site-settings' || $page == 'upload-to-storage' || $page == 'email-settings' || $page == 'social-login' || $page == 's3' || $page == 'live' || $page == 'ffmpeg' || $page == 'video_settings' || $page == 'cronjob_settings') ? 'class="open"' : ''; ?>>
              <a href="#">
                <span class="nav-link-icon">
              ...
              <ul
                <?php echo ($page == 'general-settings' || $page == 'site-settings' || $page == 'email-settings' || $page == 'social-login' || $page == 's3' || $page == 'live') ? 'style="display: block;"' : ''; ?>>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('general-settings')) { ?>
                <li>
                  <a <?php echo ($page == 'general-settings') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('general-settings'); ?>"
                ...
                <li>
                  <a <?php echo ($page == 'site-settings') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('site-settings'); ?>"
                    data-ajax="?path=site-settings">Website Information</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('ffmpeg')) { ?>
                <li>
                  <a <?php echo ($page == 'ffmpeg' || $page == 'upload-to-storage') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('ffmpeg'); ?>" data-ajax="?path=ffmpeg">Import & Upload
                    Configuration</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('video_settings')) { ?>
                <li>
                  <a <?php echo ($page == 'video_settings') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('video_settings'); ?>"
                    data-ajax="?path=video_settings">Video & Player Settings</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('email-settings')) { ?>
                <li>
                  <a <?php echo ($page == 'email-settings') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('email-settings'); ?>"
                    data-ajax="?path=email-settings">E-mail Setup</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('social-login')) { ?>
                <li>
                  <a <?php echo ($page == 'social-login') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('social-login'); ?>" data-ajax="?path=social-login">Social
                    Login Settings</a>
                </li>
                <?php } ?>
                ...
                <li>
                  <a <?php echo ($page == 'live') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('live'); ?>" data-ajax="?path=live">Setup Live
                    Streaming</a>
                </li>
                <?php } ?>
                ...
                <li>
                  <a <?php echo ($page == 'cronjob_settings') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('cronjob_settings'); ?>"
            ...
            <li
              <?php echo ($page == 'payment-settings' || $page == 'ads-settings' || $page == 'bank-receipts' || $page == 'manage-video-ads' || $page == 'create-video-ad' || $page == 'manage-website-ads' || $page == 'manage-user-ads' || $page == 'earnings' || $page == 'payment-requests') ? 'class="open"' : ''; ?>>
              <a href="#">
                <span class="nav-link-icon">
              ...
              <ul
                <?php echo ($page == 'payment-settings' || $page == 'ads-settings' || $page == 'bank-receipts' || $page == 'manage-video-ads' || $page == 'create-video-ad' || $page == 'manage-website-ads' || $page == 'manage-user-ads' || $page == 'payment-requests' || $page == 'manage-currencies') ? 'style="display: block;"' : ''; ?>>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('payment-settings')) { ?>
                <li>
                  <a <?php echo ($page == 'payment-settings') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('payment-settings'); ?>"
                ...
                <li>
                  <a <?php echo ($page == 'ads-settings') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('ads-settings'); ?>"
                ...
                <li>
                  <a <?php echo ($page == 'bank-receipts') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('bank-receipts'); ?>" data-ajax="?path=bank-receipts">
                ...
                <li>
                  <a <?php echo ($page == 'manage-video-ads' || $page ==  'create-video-ad') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-video-ads'); ?>"
                    data-ajax="?path=manage-video-ads">Manage Video Ads</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-website-ads')) { ?>
                <li>
                  <a <?php echo ($page == 'manage-website-ads') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-website-ads'); ?>"
                    data-ajax="?path=manage-website-ads">Manage Website Ads</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-user-ads')) { ?>
                <li>
                  <a <?php echo ($page == 'manage-user-ads') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-user-ads'); ?>"
                    data-ajax="?path=manage-user-ads">Manage User Ads</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('payment-requests')) { ?>
                <li>
                  <a <?php echo ($page == 'payment-requests') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('payment-requests'); ?>"
                    data-ajax="?path=payment-requests">Payment Requests</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-currencies')) { ?>
                <li>
                  <a <?php echo ($page == 'manage-currencies') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-currencies'); ?>"
                    data-ajax="?path=manage-currencies">Manage Currencies</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('earnings')) { ?>
                <li>
                  <a <?php echo ($page == 'earnings') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('earnings'); ?>" data-ajax="?path=earnings">Earnings</a>
                </li>
                <?php } ?>
              </ul>
            </li>
              ...
              <ul
                ...
                <li>
                  <a <?php echo ($page == 'add-language') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('add-language'); ?>" data-ajax="?path=add-language">Add
                    New Language & Keys</a>
                </li>
                <?php } ?>
                ...
                <li>
                  <a <?php echo ($page == 'manage-languages' || $page == 'edit-lang') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-languages'); ?>"
            ...
            <li
              <?php echo ($page == 'manage-users'  || $page == 'add-new-profile-field' || $page == 'edit-profile-field' || $page == 'verification-requests' || $page == 'monetization-requests' || $page == 'affiliates-settings') ? 'class="open"' : ''; ?>>
              <a href="#">
                <span class="nav-link-icon">
              ...
              <ul
                <?php echo ($page == 'manage-users'  || $page == 'add-new-profile-field'  || $page == 'manage-profile-fields' || $page == 'edit-profile-field' || $page == 'verification-requests' || $page == 'monetization-requests') ? 'style="display: block;"' : ''; ?>>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-users')) { ?>
                <li>
                  <a <?php echo ($page == 'manage-users') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-users'); ?>" data-ajax="?path=manage-users">Manage
                    Users</a>
                </li>
                <?php } ?>
                ...
                <li>
                  <a <?php echo ($page == 'affiliates-settings') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('affiliates-settings'); ?>"
                    data-ajax="?path=affiliates-settings">Affiliates Settings</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-profile-fields')) { ?>
                <li>
                  <a <?php echo ($page == 'manage-profile-fields' || $page == 'edit-profile-field') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-profile-fields'); ?>"
                    data-ajax="?path=manage-profile-fields">Manage Custom Profile Fields</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('verification-requests')) { ?>
                <li>
                  <a <?php echo ($page == 'verification-requests') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('verification-requests'); ?>"
                    data-ajax="?path=verification-requests">Manage Verification Requests</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('monetization-requests')) { ?>
                <li>
                  <a <?php echo ($page == 'monetization-requests') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('monetization-requests'); ?>"
                    data-ajax="?path=monetization-requests">Manage Monetization Requests</a>
                </li>
                <?php } ?>
              </ul>
            </li>
            ...
            <li
              <?php echo ($page == 'manage-videos' || $page == 'manage-comments' || $page == 'import-from-youtube' || $page == 'import-from-dailymotion' || $page == 'sold_videos_analytics' || $page == 'import-from-twitch') ? 'class="open"' : ''; ?>>
              <a href="#">
                <span class="nav-link-icon">
              ...
              <ul
                <?php echo ($page == 'manage-videos' || $page == 'import-from-youtube' || $page == 'import-from-dailymotion' || $page == 'sold_videos_analytics' || $page == 'import-from-twitch') ? 'style="display: block;"' : ''; ?>>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-videos')) { ?>
                <li>
                  <a <?php echo ($page == 'manage-videos') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-videos'); ?>"
                    data-ajax="?path=manage-videos">Manage Videos</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-comments')) { ?>
                <li>
                  <a <?php echo ($page == 'manage-comments') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-comments'); ?>"
                    data-ajax="?path=manage-comments">Manage Video Comments</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHaveMultiPermission(['import-from-youtube','import-from-dailymotion','import-from-twitch'])) { ?>
                <li
                  <?php echo ($page == 'import-from-youtube' || $page == 'import-from-dailymotion' || $page == 'import-from-twitch') ? 'class="open"' : ''; ?>>
                  <a href="#">
                    <span>Import Videos</span>
                  </a>
                  <ul
                    <?php echo ($page == 'import-from-youtube' || $page == 'import-from-dailymotion' || $page == 'sold_videos_analytics' || $page == 'import-from-twitch') ? 'style="display: block;"' : ''; ?>>
                    <?php if ($pt->user->admin == 1 || CheckHavePermission('import-from-youtube')) { ?>
                    <li>
                      <a <?php echo ($page == 'import-from-youtube') ? 'class="active"' : ''; ?>
                        href="<?php echo PT_LoadAdminLinkSettings('import-from-youtube'); ?>"
                        data-ajax="?path=import-from-youtube">Import From YouTube</a>
                    </li>
                    <?php } ?>
                    <?php if ($pt->user->admin == 1 || CheckHavePermission('import-from-dailymotion')) { ?>
                    <li>
                      <a <?php echo ($page == 'import-from-dailymotion') ? 'class="active"' : ''; ?>
                        href="<?php echo PT_LoadAdminLinkSettings('import-from-dailymotion'); ?>"
                        data-ajax="?path=import-from-dailymotion">Import From Dailymotion</a>
                    </li>
                    <?php } ?>
                    <?php if ($pt->user->admin == 1 || CheckHavePermission('import-from-twitch')) { ?>
                    <li>
                      <a <?php echo ($page == 'import-from-twitch') ? 'class="active"' : ''; ?>
                        href="<?php echo PT_LoadAdminLinkSettings('import-from-twitch'); ?>"
                        data-ajax="?path=import-from-twitch">Import From Twitch</a>
                    </li>
                    <?php } ?>
                  </ul>
                </li>
            ...
            <li <?php echo ($page == 'manage-movies' || $page == 'manage-movies-category') ? 'class="open"' : ''; ?>>
              ...
              <ul
                <?php echo ($page == 'manage-movies' || $page == 'manage-movies-category') ? 'style="display: block;"' : ''; ?>>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-movies')) { ?>
                <li>
                  <a <?php echo ($page == 'manage-movies') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-movies'); ?>"
                    data-ajax="?path=manage-movies">Manage Movies</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-movies-category')) { ?>
                <li>
                  <a <?php echo ($page == 'manage-movies-category') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-movies-category'); ?>"
                    data-ajax="?path=manage-movies-category">Manage Categories</a>
                </li>
                <?php } ?>
              </ul>
            </li>
            ...
            <li
              <?php echo ($page == 'manage-articles' || $page == 'create-article' || $page == 'edit-article') ? 'class="open"' : ''; ?>>
              <a href="#">
                <span class="nav-link-icon">
              ...
              <ul
                <?php echo ($page == 'manage-articles' || $page == 'create-article' || $page == 'edit-article') ? 'style="display: block;"' : ''; ?>>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('create-article')) { ?>
                <li>
                  <a <?php echo ($page == 'create-article') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('create-article'); ?>">Create New Article</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-articles')) { ?>
                <li>
                  <a <?php echo ($page == 'manage-articles' || $page == 'edit-article') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-articles'); ?>"
                    data-ajax="?path=manage-articles">Manage Articles</a>
                </li>
                <?php } ?>
              </ul>
            </li>
            ...
            <li <?php echo ($page == 'manage_categories' || $page == 'manage_sub_categories') ? 'class="open"' : ''; ?>>
              ...
              <ul
                <?php echo ($page == 'manage_categories' || $page == 'manage_sub_categories') ? 'style="display: block;"' : ''; ?>>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage_categories')) { ?>
                <li>
                  <a <?php echo ($page == 'manage_categories') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage_categories'); ?>"
                    data-ajax="?path=manage_categories">Manage Categories</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage_sub_categories')) { ?>
                <li>
                  <a <?php echo ($page == 'manage_sub_categories') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage_sub_categories'); ?>"
                    data-ajax="?path=manage_sub_categories">Manage Sub Categories</a>
                </li>
                <?php } ?>
              </ul>
            </li>
            ...
            <li <?php echo ($page == 'prosys-settings' || $page == 'manage-payments') ? 'class="open"' : ''; ?>>
              ...
              <ul
                <?php echo ($page == 'prosys-settings' || $page == 'manage-payments') ? 'style="display: block;"' : ''; ?>>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('prosys-settings')) { ?>
                <li>
                  <a <?php echo ($page == 'prosys-settings') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('prosys-settings'); ?>"
                    data-ajax="?path=prosys-settings">Pro System Settings</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-payments')) { ?>
                <li>
                  <a <?php echo ($page == 'manage-payments') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-payments'); ?>"
                    data-ajax="?path=manage-payments">Recent Payments</a>
                </li>
                <?php } ?>
              </ul>
            </li>
            ...
            <li
              <?php echo ($page == 'manage-themes' || $page == 'change-site-desgin' || $page == 'custom-design') ? 'class="open"' : ''; ?>>
              <a href="#">
                <span class="nav-link-icon">
              ...
              <ul
                <?php echo ($page == 'manage-themes' || $page == 'change-site-desgin' || $page == 'custom-design') ? 'style="display: block;"' : ''; ?>>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-themes')) { ?>
                <!-- <li>
                  <a <?php echo ($page == 'manage-themes') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-themes'); ?>"
                ...
                <li>
                  <a <?php echo ($page == 'change-site-desgin') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('change-site-desgin'); ?>"
                    data-ajax="?path=change-site-desgin">Update Website Design</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('custom-design')) { ?>
                <li>
                  <a <?php echo ($page == 'custom-design') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('custom-design'); ?>"
                    data-ajax="?path=custom-design">Custom Design</a>
                </li>
                <?php } ?>
              </ul>
            </li>
            ...
            <li
              <?php echo ($page == 'manage-announcements' || $page == 'ban-users' || $page == 'mass-notifications' || $page == 'manage-invitation-keys' || $page == 'manage-invitation' || $page == 'auto_subscribe' || $page == 'auto-delete' || $page == 'manage-activities' || $page == 'newsletters') ? 'class="open"' : ''; ?>>
              <a href="#">
                <span class="nav-link-icon">
              ...
              <ul
                <?php echo ($page == 'manage-announcements' || $page == 'ban-users' || $page == 'mass-notifications' || $page == 'manage-invitation-keys' || $page == 'manage-invitation' || $page == 'auto_subscribe' || $page == 'clean-videos' || $page == 'auto-delete' || $page == 'manage-activities' || $page == 'newsletters') ? 'style="display: block;"' : ''; ?>>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-announcements')) { ?>
                <li>
                  <a <?php echo ($page == 'manage-announcements') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-announcements'); ?>"
                    data-ajax="?path=manage-announcements">Manage Announcements</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('ban-users')) { ?>
                <li>
                  <a <?php echo ($page == 'ban-users') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('ban-users'); ?>" data-ajax="?path=ban-users">Ban
                    Users</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-activities')) { ?>
                <li>
                  <a <?php echo ($page == 'manage-activities') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-activities'); ?>"
                    data-ajax="?path=manage-activities">Manage Activities</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('mass-notifications')) { ?>
                <li>
                  <a <?php echo ($page == 'mass-notifications') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('mass-notifications'); ?>"
                ...
                <li>
                  <a <?php echo ($page == 'manage-invitation-keys') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-invitation-keys'); ?>"
                    data-ajax="?path=manage-invitation-keys">Manage Invitation Keys</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-invitation')) { ?>
                <li>
                  <a <?php echo ($page == 'manage-invitation') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-invitation'); ?>"
                    data-ajax="?path=manage-invitation">Users Invitation</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('auto_subscribe')) { ?>
                <li>
                  <a <?php echo ($page == 'auto_subscribe') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('auto_subscribe'); ?>"
                    data-ajax="?path=auto_subscribe">Auto Subscribe</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('auto-delete')) { ?>
                <li>
                  <a <?php echo ($page == 'auto-delete') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('auto-delete'); ?>" data-ajax="?path=auto-delete">Auto
                    Delete Videos</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('clean-videos')) { ?>
                <li>
                  <a <?php echo ($page == 'clean-videos') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('clean-videos'); ?>" data-ajax="?path=clean-videos">Clean
                    Dead Videos</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('newsletters')) { ?>
                <li <?php echo ($page == 'newsletters') ? 'class="active"' : ''; ?>>
                  <a href="<?php echo PT_LoadAdminLinkSettings('newsletters'); ?>"
                    data-ajax="?path=newsletters">Newsletter</a>
                </li>
                <?php } ?>
              </ul>
            </li>
            ...
            <li <?php echo ($page == 'manage-video-reports' || $page == 'copy_report') ? 'class="open"' : ''; ?>>
              ...
              <ul
                <?php echo ($page == 'manage-video-reports' || $page == 'copy_report') ? 'style="display: block;"' : ''; ?>>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-video-reports')) { ?>
                <li>
                  <a <?php echo ($page == 'manage-video-reports') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-video-reports'); ?>"
                    data-ajax="?path=manage-video-reports">
                    Manage video reports
                  </a>
                </li>
                <?php } ?>
                ...
                <li>
                  <a <?php echo ($page == 'copy_report') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('copy_report'); ?>" data-ajax="?path=copy_report">
            ...
            <li
              <?php echo ($page == 'manage-pages' || $page == 'add-new-custom-page' || $page == 'manage-custom-pages' || $page == 'edit-custom-page' || $page == 'manage-faqs' || $page == 'seo') ? 'class="open"' : ''; ?>>
              <a href="#">
                <span class="nav-link-icon">
              ...
              <ul
                <?php echo ($page == 'manage-pages' || $page == 'add-new-custom-page' || $page == 'manage-custom-pages' || $page == 'edit-custom-page' || $page == 'seo') ? 'style="display: block;"' : ''; ?>>
                ...
                <li>
                  <a <?php echo ($page == 'manage-custom-pages' || $page == 'add-new-custom-page' || $page == 'edit-custom-page') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-custom-pages'); ?>"
                ...
                <li>
                  <a <?php echo ($page == 'manage-pages') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-pages'); ?>" data-ajax="?path=manage-pages">Manage
                    Pages</a>
                </li>
                <?php } ?>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('manage-faqs')) { ?>
                <li>
                  <a <?php echo ($page == 'manage-faqs') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('manage-faqs'); ?>" data-ajax="?path=manage-faqs">Manage
                    FAQs</a>
                </li>
                <?php } ?>
                ...
                <li>
                  <a <?php echo ($page == 'seo') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('seo'); ?>" data-ajax="?path=seo">Manage Pages SEO</a>
                </li>
                <?php } ?>
              </ul>
            </li>
              ...
              <ul <?php echo ($page == 'create-new-sitemap') ? 'style="display: block;"' : ''; ?>>
                ...
                <li>
                  <a <?php echo ($page == 'create-new-sitemap') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('create-new-sitemap'); ?>"
                    data-ajax="?path=create-new-sitemap">Create Sitemap</a>
                </li>
                <?php } ?>
              </ul>
            </li>
            ...
            <li <?php echo ($page == 'api-settings' || $page == 'push-notifications-system') ? 'class="open"' : ''; ?>>
              ...
              <ul
                <?php echo ($page == 'api-settings' || $page == 'push-notifications-system') ? 'style="display: block;"' : ''; ?>>
                <?php if ($pt->user->admin == 1 || CheckHavePermission('api-settings')) { ?>
                <li>
                  <a <?php echo ($page == 'api-settings') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('api-settings'); ?>" data-ajax="?path=api-settings">Manage
                    API Access Keys</a>
                </li>
                <?php } ?>
                ...
                <li>
                  <a <?php echo ($page == 'push-notifications-system') ? 'class="active"' : ''; ?>
                    href="<?php echo PT_LoadAdminLinkSettings('push-notifications-system'); ?>"
                    data-ajax="?path=push-notifications-system">Push Notifications System</a>
                </li>
                <?php } ?>
              </ul>
            </li>
            ...
            <li>
              <a <?php echo ($page == 'backup') ? 'class="active"' : ''; ?>
                href="<?php echo PT_LoadAdminLinkSettings('backup'); ?>" data-ajax="?path=backup">
                <span class="nav-link-icon">
            ...
            <li>
              <a <?php echo ($page == 'system_status') ? 'class="active"' : ''; ?>
                href="<?php echo PT_LoadAdminLinkSettings('system_status'); ?>" data-ajax="?path=system_status">
                <span class="nav-link-icon">
            ...
            <a class="pow_link" href="https://www.kenyanstream.com/" target="_blank">
              <p>Powered by</p>
              <img
                src="https://shorts.kenyanstream.com/themes/default/img/logo-light.png?cache=245<?php echo($pt->config->logo_cache) ?>">
  ...
  function showEncryptedAlert() {
    ...
    if ($(".alert_<?php echo($value) ?>").length == 0) {
      $("input[name='<?php echo($value) ?>']").before(
        '<div class="alert alert-danger alert_<?php echo($value) ?>" role="alert">The secret key is not showing due security reasons, you can still overwrite the current one.</div>'
      );
      $("textarea[name='<?php echo($value) ?>']").before(
        '<div class="alert alert-danger alert_<?php echo($value) ?>" role="alert">The secret key is not showing due security reasons, you can still overwrite the current one.</div>'
      );
    }
    <?php } } ?>
  ...
  function ChangeMode(mode) {
    if (mode == 'day') {
      ...
      $('.admin_mode').html(
        '<span id="night-mode-text">Night mode </span><svg class="feather feather-moon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>'
      );
      $('.admin_mode').attr('onclick', "ChangeMode('night')");
    } else {
      $('body').addClass('dark');
      $('.admin_mode').html(
        '<span id="night-mode-text">Day mode </span><svg class="feather feather-moon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>'
      );
  ...
  function SelectProModel(type, self) {
    if ($(self).val() == 'pro') {
      $.get('<?php echo $pt->config->site_url; ?>/aj/ap/select_pro_model', {
        package_type: type
      }, function(data) {
